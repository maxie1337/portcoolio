...
export function Services() {
    return(
        ...
        id="services" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            className="text-center mb-2 text-lg font-Ovo">Vad erbjuder jag?</motion.h4>
            <motion.h2 
            initial={{y: -20, opacity: 0}}
            whileInView={{y: 0, opacity: 1}}
            ...
            className="grid grid-auto-cols gap-6 my-10">

                {serviceData.map(({icon, title, description, link}, index)=>(
                    <motion.div
                    whileHover={{scale: 1.05}}
                    className="border border-gray-400 rounded-lg px-8 py-12 hover:shadow-black hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white" key={index}>
